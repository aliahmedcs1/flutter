...
class SearchClientBill extends StatefulWidget {
//   String nameOne ;
//  SearchClient(this.nameOne){
//    SearchClientState._name =nameOne;
//  }
  String todo;
  SearchClientBill({Key key, @required this.todo}) : super(key: key);
  @override
  State<StatefulWidget> createState() {
    return new SearchClientBillState();
  }
}

class SearchClientBillState extends State<SearchClientBill> {
  double left_01;
  double width_22;
  double width_99;
              ...
              child: new Column(
                ...
                children: <Widget>[
                  new Padding(
                    ...
                    child: new Text("الموجود: ${_name ?? 'مفيش اسمع قولة مفيش'}"),
                  ),
                  new Padding(
                    padding: const EdgeInsets.symmetric(
