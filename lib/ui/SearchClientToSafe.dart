...
class SearchClientToSafe extends StatefulWidget {
//   String nameOne ;
//  SearchClient(this.nameOne){
//    SearchClientState._name =nameOne;
//  }
  String todo;
  SearchClientToSafe({Key key, @required this.todo}) : super(key: key);
  @override
  State<StatefulWidget> createState() {
    return new SearchClientToSafeState();
  }
}

class SearchClientToSafeState extends State<SearchClientToSafe> {
  double left_01;
  double width_22;
  double width_99;
  static String _name = "مفيش";
                          ...
                          new MaterialButton(
                            color: Colors.redAccent,
                              ...
                              onPressed: () {
                                ...
                                print("XXXXXXXXXXXXXXXXXXXXXXXXXXXX$_name");
